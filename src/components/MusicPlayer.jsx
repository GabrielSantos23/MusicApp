...
function MusicPlayer() {
  return (
    <div className='musicPlayer mt-5 flex w-[100%] flex-col rounded-xl border-2 border-black bg-[#232A4E] px-5 py-3'>
      {/* Upper Part */}
      <div className='upperPart flex items-center justify-between'>
        ...
        <div className='profile flex'>
          <img
            ...
            alt=''
            className='h-[2.5rem] w-[2.5rem] rounded-full border-2 border-white'
          />
          <div className='detailsf ml-4 flex flex-col'>
      ...
      {/* lower part */}
      <div className='lowerPart mt-5 flex items-center justify-between'>
        {/* track */}
        <div className='track flex flex-[2] items-center justify-between text-sm text-gray-500'>
          <span>2: 30</span>
          <img
        ...
        <div className='controls flex flex-1 items-center justify-around'>
          ...
          {/* pauseButton */}
          <div className='pauseButton relative flex items-center'>
            {/* cicrle */}
